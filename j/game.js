// ================= MAP SETUP =================
const map = L.map('map', {
  zoomControl: false,  // optional: remove zoom UI
  dragging: false,
  scrollWheelZoom: false,
  doubleClickZoom: false,
  boxZoom: false,
  keyboard: false
}).setView([59.4841, 18.45], 9);

// Old watercolor tiles from Stamen
...
function showEventCard(e){
  cardName.innerText=e.name; cardType.innerText="Event"; cardEffect.innerText=e.name;
...
function animateMove(marker,start,end,duration=400,callback){
...
function movePlayer(player,island){
  const start=player.island.coords, end=island.coords;
